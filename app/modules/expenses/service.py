...
def create_expense(tenant_id: str, user_id: str, description: str, value: float) -> dict:
    sb = get_service_client()
    expense = (
        sb.table("expenses")
    ...
    log_audit_event(tenant_id, user_id, "INSERT", "expenses", expense["id"])
    return expense


def delete_expense(tenant_id: str, actor_user_id: str, expense_id: str) -> None:
    sb = get_service_client()
    ...
    log_audit_event(tenant_id, actor_user_id, "DELETE", "expenses", expense_id)
